...
export async function discoverPools({
  ...
  const s = spotProfile
    ? {
      ...
      minMcap: config.spotDiscovery.minMarketCapUsd,
      maxMcap: config.spotDiscovery.maxMarketCapUsd,
      minHolders: config.spotDiscovery.minHolders,
      minVolume: config.spotDiscovery.minVolume5mUsd,
      minVolumeActiveTvlRatio: config.spotDiscovery.minVolumeLiquidityRatio,
      minTvl: config.spotDiscovery.minLiquidityUsd,
      maxTvl: null,
      minBinStep: null,
      maxBinStep: null,
      minFeeActiveTvlRatio: null,
      minOrganic: config.spotDiscovery.minOrganic,
      minTokenAgeHours: config.spotDiscovery.minTokenAgeMinutes / 60,
      maxTokenAgeHours: config.spotDiscovery.maxTokenAgeHours,
      allowedLaunchpads: [],
      blockedLaunchpads: [],
