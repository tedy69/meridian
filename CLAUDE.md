...
| `risk-intelligence.js` | ~450 | Pure deterministic risk layer: adaptive 1h/2h/4h realized-loss circuit breaker, half-size recovery until a profitable close, fresh pool fundamental gate, mint-bound token audit, and compact realized expectancy/tail-risk brief for SCREENER. |
